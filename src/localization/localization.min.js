...
!(function (w, d, u) {
  var translationLang
  getQSParameterByName('lang', w.location.href)
    ? (translationLang = getQSParameterByName('lang', w.location.href))
    : 2 ==
      parseURL(w.location.href, !1).substring(0, 4).replace(/\//g, '').length
    ? (translationLang = parseURL(w.location.href, !1)
        .substring(0, 4)
        .replace(/\//g, ''))
    : 2 ==
      parseURL(w.location.href, !0).substring(
        0,
        parseURL(w.location.href, !0).indexOf('.')
      ).length
    ? (translationLang = parseURL(w.location.href, !0).substring(
        0,
        parseURL(w.location.href, !0).indexOf('.')
      ))
    : 2 ==
        parseURL(w.location.href, !0).substring(
          parseURL(w.location.href, !0).lastIndexOf('.') + 1,
          parseURL(w.location.href, !0).length
        ).length &&
      (translationLang = parseURL(w.location.href, !0).substring(
        parseURL(w.location.href, !0).lastIndexOf('.') + 1,
        parseURL(w.location.href, !0).length
  ...
  function parseURL(e, t) {
    var a
    return (
      -1 < (e = decodeURIComponent(e)).indexOf('://')
        ? ((a = e.split('/')[2]),
          t || (a = e.split('/')[0] + '//' + e.split('/')[2]))
        : (a = e.split('/')[0]),
      t ? a : e.replace(a, '')
    )
  }
  ...
  function getElementsByTagNames(e) {
    for (var t = [], a = 0, n = e.length; a < n; a++)
      for (var r = d.getElementsByTagName(e[a]), i = 0; i < r.length; i++)
        t.push(r[i])
    return t
  }
  ...
  function rewriteUrl(e, t, a, n) {
    var r
    '?' == n
      ? (-1 != e.attributes.href.value.indexOf('#') &&
          ((r = e.attributes.href.value.split('#')[1]),
          (e.attributes.href.value = e.attributes.href.value.replace(
            '#' + r,
            ''
          ))),
        getQSParameterByName('lang', e.attributes.href.value)
          ? (e.attributes.href.value = e.attributes.href.value
              .toLowerCase()
              .replace(
                'lang=' + getQSParameterByName('lang', e.attributes.href.value),
                'lang=' + a
              ))
          : -1 != e.attributes.href.value.indexOf('?')
          ? (e.attributes.href.value += '&lang=' + a)
          : (e.attributes.href.value += '?lang=' + a),
        r && (e.attributes.href.value += '#' + r))
      : '/' == n
      ? parseURL(t, !1).substring(0, 4).replace(/\//g, '').toLowerCase() == a
        ? (e.attributes.href.value =
            t.split('/')[0] + '//' + parseURL(t, !0) + parseURL(t, !1))
        : (e.attributes.href.value =
            t.split('/')[0] +
            '//' +
            parseURL(t, !0) +
            ...
            a +
            parseURL(t, !1))
      : (e.attributes.href.value = t.split('/')[0] + '//' + n + parseURL(t, !1))
  }
  function encodeAllSpecialTags(e) {
    ...
    if (a)
      for (var n = 0; n < a.length; n++)
        e = e.replace(
          t,
          '&lt;' + a[n].substring(1, a[n].length - 1).toLowerCase() + '&gt;'
        )
    ...
    if (linguJSON) {
      ...
      if (1 < languages.length) {
        ...
        for (
          ...
          if (languages[i].lang_code != currlangcode) {
            ...
            if (languages[i].url_pattern && '?' != languages[i].url_pattern)
              '/' == languages[i].url_pattern &&
                (href =
                  ...
                  parseURL(w.location.href, !1)
                    ...
                    ? w.location.protocol +
                      '//' +
                      parseURL(w.location.href, !0) +
                      parseURL(w.location.href, !1).replace(
                        parseURL(w.location.href, !1).substring(0, 4),
              ...
              -1 != w.location.href.indexOf('#') &&
                ((fragment = w.location.href.split('#')[1]),
                (href = w.location.href.replace('#' + fragment, ''))),
                (href = getQSParameterByName('lang', w.location.href)
                  ? w.location.href
                      .toLowerCase()
                      .replace(
                  ...
                  : -1 != w.location.href.indexOf('?')
                  ? w.location.href + '&lang=' + languages[i].lang_code
                  : w.location.href + '?lang=' + languages[i].lang_code)
            if (
        ...
        if (
          ...
          (translateNowItem.innerHTML =
            'Translated Websites<br />Powered by Lingumania'),
        ...
        if (linguJSON.translated_pages) {
          ...
          if (
            ...
            for (; customMenuContainer.firstChild; )
      ...
      if (
        ...
        for (
          var translatedSegments = linguJSON.translated_segments,
            ...
            i = 0;
          i < specialTags.length;
          i++
        )
          specialTags[i].parentNode &&
        ...
        for (
          ...
          if (null != node.nodeValue) {
            ...
            for (
              var canBeTranslated = !0, current = node;
              canBeTranslated && current.parentNode;

            )
              if (((current = current.parentNode), 'STYLE' == current.nodeName))
                canBeTranslated = !1
              else if (current.attributes)
                for (var i = 0; i < current.attributes.length; i++)
                  'notranslate' == current.attributes[i].value &&
                    (canBeTranslated = !1)
            if (canBeTranslated)
              try {
                for (
                  var startingWhiteSpaceRegex = /^\s+/gim,
                    startingWhiteSpaceMatches = startingWhiteSpaceRegex.exec(
                      node.nodeValue
                    ),
                    endingWhiteSpaceRegex = /\s+$/gim,
                    endingWhiteSpaceMatches = endingWhiteSpaceRegex.exec(
                      node.nodeValue
                    ),
                    i = 0;
                  ...
                  if (
                    (null == translatedSegments[i].target &&
                      eval('translatedSegments[i].target_' + currlangcode) &&
                    ...
                    if (
                      (startingWhiteSpaceMatches &&
                        (target = startingWhiteSpaceMatches[0] + target),
                      endingWhiteSpaceMatches &&
            ...
            if (
              ...
              var wrap = d.createElement('span'),
                frag = d.createDocumentFragment()
              for (wrap.innerHTML = node.nodeValue; wrap.firstChild; )
                frag.appendChild(wrap.firstChild)
              nodes.push(node), fragments.push(frag)
            }
          }
        for (
          var inputs = d.getElementsByTagName('input'), i = 0;
          i < inputs.length;
          i++
        ) {
          var input = inputs[i]
        ...
        for (
          var imgs = d.getElementsByTagName('img'), i = 0;
          i < imgs.length;
          i++
        ) {
          var img = imgs[i]
          if (
            ...
            for (var j = 0; j < translatedSegments.length; j++)
              if (
                translatedSegments[j].source == img.attributes.alt.value.trim()
              ) {
        ...
        for (
          var metas = d.getElementsByTagName('meta'), i = 0;
          i < metas.length;
          i++
        ) {
          var meta = metas[i]
        ...
        for (
          var links = d.getElementsByTagName('a'), i = 0;
          i < links.length;
          i++
        ) {
          var link = links[i]
          if (
            ...
            'notranslate' != link.parentNode.className
          ) {
            ...
            if (
              ...
              for (var j = 0; j < linkTranslations.length; j++) {
                ...
                if (
                  parseURL(linkTranslations[j].source.trim(), !1) ==
                  comparableLink
                ) {
                  link.attributes.href.value = linkTranslations[j].target
                  break
              ...
              if (linguJSON.translated_pages) {
                for (
                  var comparableLink = createComparableLink(
                    ...
                    j = 0;
                  j < linguJSON.translated_pages.length;
                  j++
                )
                  if (
                    comparableLink ==
      ...
      if (
        ...
        0 < linguJSON.translated_image_segments.length &&
        isTranslated &&
        currlangcode != sourceLang.lang_code
      )
        for (
          ...
          if (img.attributes.src)
            for (var j = 0; j < translatedImageSegments.length; j++)
              if (
                (null == translatedImageSegments[j].img_target &&
                  eval(
  ...
  function createComparableLink(e, t) {
    ...
    return (
      (a != parseURL(w.location.href, !0) && a != t[0].url_pattern) ||
        (a = '/'),
      (a = a.replace(parseURL(w.location.href, !0), '')),
      '?' != t[0].url_pattern && (a = a.replace(t[0].url_pattern, '')),
  ...
  ;(TreeWalker.prototype.parentNode = function () {
    ...
    do {
      if (e === this.root || !e.parentNode || e.parentNode === this.root)
        return null
      e = e.parentNode
    ...
    (TreeWalker.prototype.firstChild = function () {
      for (
        var e = this.currentNode.firstChild;
        e && this._getFilteredStatus(e) !== this.NodeFilter.FILTER_ACCEPT;
    ...
    (TreeWalker.prototype.lastChild = function () {
      for (
        var e = this.currentNode.lastChild;
        e && this._getFilteredStatus(e) !== this.NodeFilter.FILTER_ACCEPT;
    ...
    (TreeWalker.prototype.nextNode = function () {
      for (var e = this.currentNode; e; ) {
        ...
        if (e && this._getFilteredStatus(e) === this.NodeFilter.FILTER_ACCEPT)
          break
      }
      return e && (this.currentNode = e), e
    }),
    (TreeWalker.prototype.previousNode = function () {
      for (var e = this.currentNode; e; ) {
        if (e.previousSibling)
          ...
          e = e.parentNode && e.parentNode !== this.root ? e.parentNode : null
        if (e && this._getFilteredStatus(e) === this.NodeFilter.FILTER_ACCEPT)
          break
      }
      return e && (this.currentNode = e), e
    ...
    (TreeWalker.prototype.nextSibling = function () {
      for (
        var e = this.currentNode;
        e &&
        (e.nextSibling && (e = e.nextSibling),
        this._getFilteredStatus(e) !== this.NodeFilter.FILTER_ACCEPT);
  ...
  w.addEventListener
    ? w.addEventListener('load', linguLoader, !1)
